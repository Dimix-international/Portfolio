...
export const featuredPortfolio: Array<DataPortfolioType> = [
    {
        id: 1,
        title: "Social Media App",
        img:
            "https://cdn-ext.fanatical.com/production/product/1280x720/f26a6d71-ac23-4c42-b30f-3d31e7d0c5e0.jpeg",
    },
    {
        id: 2,
...
export const webPortfolio: Array<DataPortfolioType> = [
    {
        id: 1,
...
export const mobilePortfolio: Array<DataPortfolioType> = [
    {
        id: 1,
...
export const designPortfolio: Array<DataPortfolioType> = [
    {
        id: 1,
...
export const contentPortfolio: Array<DataPortfolioType> = [
    {
        id: 1,
